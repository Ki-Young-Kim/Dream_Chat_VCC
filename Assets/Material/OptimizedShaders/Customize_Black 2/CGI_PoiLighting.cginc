...
void calculateBasePassLightMaps()
{
        ...
        switch((0.0 /*_LightingRampType*/))
        {
            ...
            case 1: // Math Gradient
            {
                ...
                float3 shadowColor = float4(0,0,0,1);
        ...
        if ((0.0 /*_LightingMode*/) == 2) // Wrapped
        {
            ...
            {
                poiLight.rampedLightMap = lerp(float4(0,0,0,1) * lerp(poiLight.indirectLighting, 1, (0.0 /*_LightingIgnoreAmbientColor*/)), float3(1, 1, 1), saturate(1 - smoothstep((0.0 /*_LightingGradientStart*/) - .000001, (0.5 /*_LightingGradientEnd*/), 1 - poiLight.lightMap)));
...
float3 calculateNonImportantLighting(float attenuation, float attenuationDotNL, float3 albedo, float3 lightColor, half dotNL, half correctedDotNL)
{
    ...
    else //if((1.0 /*_LightingAdditiveType*/) == 2) // Wrapped
    {
        ...
        poiLight.rampedLightMap = lerp(float4(0,0,0,1), float3(1, 1, 1), saturate(1 - smoothstep((0.0 /*_LightingGradientStart*/) - .000001, (0.5 /*_LightingGradientEnd*/), 1 - uv)));
    ...
    float3 finalLighting = 1;
        ...
        switch((0.0 /*_LightingMode*/))
        {
            ...
            case 3: // Skin
            {
                ...
                finalLighting = min(lerp(indirectLighting * float4(0,0,0,1), float4(0,0,0,1), (0.0 /*_LightingIgnoreAmbientColor*/)) + (sss * directLighting), directLighting);
            }
            break;
            case 4:
            {
