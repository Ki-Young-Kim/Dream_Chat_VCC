...
void calculateBasePassLightMaps()
{
        ...
        if ((1.0 /*_LightingDetailShadowsEnabled*/))
        {
        ...
        if ((0.0 /*_LightingMode*/) == 2) // Wrapped
        {
            ...
            if ((1.0 /*_LightingRampType*/) == 0) // Ramp Texture
            {
                poiLight.rampedLightMap = lerp(1, UNITY_SAMPLE_TEX2D(_ToonRamp, poiLight.lightMap + (0.05 /*_ShadowOffset*/)).rgb, shadowStrength.r);
            }
            else if ((1.0 /*_LightingRampType*/) == 1) // Math Gradient
            {
...
float3 calculateNonImportantLighting(float attenuation, float attenuationDotNL, float3 albedo, float3 lightColor, half dotNL, half correctedDotNL)
{
    ...
    else //if((1.0 /*_LightingAdditiveType*/) == 2) // Wrapped
    {
        ...
        poiLight.rampedLightMap = 1;
        if ((1.0 /*_LightingRampType*/) == 1) // Math Gradient
    ...
    float3 finalLighting = 1;
        ...
        switch((0.0 /*_LightingMode*/))
        {
            ...
            case 2: // or wrapped
            {
                ...
                if ((1.0 /*_LightingEnableHSL*/))
                {
                    float3 HSLMod = float3((0.538 /*_LightingShadowHue*/) * 2 - 1, (0.5 /*_LightingShadowSaturation*/) * 2 - 1, (0.5 /*_LightingShadowLightness*/) * 2 - 1) * (1 - poiLight.rampedLightMap);
